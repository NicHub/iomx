...
""",
    ...
    "iomx/protocols/serial.py": '"""Serial protocol implementation for iomx."""\n',
    "iomx/protocols/mqtt.py": '"""MQTT protocol implementation for iomx."""\n',
    "iomx/protocols/websocket.py": '"""WebSocket protocol implementation for iomx."""\n',
